 ...
 */
public class ProfileAction extends FacebookAction<FacebookProfile> {

    private FacebookProfile.Properties mProperties;

    public ProfileAction(AnterosFacebookSessionManager sessionManager) {
    ...
    @Override
    protected void processAndReturnResponse(OnActionFacebookListener<FacebookProfile> actionListener, GraphResponse response) {
        final OnActionFacebookListener<FacebookProfile> listener = actionListener;
